...
ENT.Model = "models/weapons/w_shot_m3super90.mdl"
...
function ENT:Think()
	...
	local entities = ents.FindInSphere(self.Entity:GetPos(),1500)
		...
		for k,v in ipairs(entities) do
			...
			if (v:IsNPC() || v:IsPlayer()) then
				if ( v:GetClass() == "npc_leakheli" || v:GetClass() == "npc_pelican" || v:GetClass() == "npc_k60" || v:GetClass() == "npc_harrier") then return end
