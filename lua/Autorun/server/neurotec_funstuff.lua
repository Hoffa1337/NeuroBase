					...
					{ 
						...
						Callback = function( ply, txt, team )	
										...
										if( IsValid( Target ) ) then
											...
											Target:SetJumpPower( 200 * .125 )
											Target:SetViewOffsetDucked( Vector(0,0,6 ) )
					...
					{ 
						...
						Callback = function( ply, txt, team )	
										...
										if( IsValid( Target ) ) then
											...
											Target:ResetHull()
											Target:SetHull( mins, maxs )
											Target:SetViewOffset( Target.tViewOffset or Vector(0,0,72) )
											Target:SetViewOffset( Target.tViewOffset or Vector(0,0,36) )
