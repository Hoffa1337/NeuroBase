...
AMMO_VELOCITY_AP_SHELL = 4050 -- 1000 m/s (not used yet)
AMMO_VELOCITY_APCR_SHELL = 4050 -- 1500 m/s
AMMO_VELOCITY_HE_SHELL =  4000--850 m/s
AMMO_VELOCITY_HEAT_SHELL = 4040--1050 m/s (not used yet)

TANK_RANGE_ARTILLERY_SHELL = 16500
TANK_RANGE_HE_SHELL = 16500

AMMO_VELOCITY_APHE_SHELL = 4050  -- 950m/s
AMMO_VELOCITY_INCENDIARY_SHELL = 3050-- 900m/s 
AMMO_VELOCITY_CLUSTER_SHELL = 3050 -- 1500 ft/s
AMMO_VELOCITY_FLAK_SHELL =  3050-- 800 m/s
AMMO_VELOCITY_ARTILLERY_SHELL = 3050 --4956 --Use low value to prevent the shell from hitting the skybox ceiling.
AMMO_VELOCITY_AUTOCANNON_SHELL = 4560
